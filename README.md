# `ZoneDetect_jll.jl` (v2024.9.13+0)

[![deps](https://juliahub.com/docs/ZoneDetect_jll/deps.svg)](https://juliahub.com/ui/Packages/General/ZoneDetect_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/528cc5e636c22d282ba98df31ef33e82eb6dbdcd/Z/ZoneDetect/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `ZoneDetect_jll.jl` have been built from these sources:

* git repository: https://github.com/BertoldVdb/ZoneDetect (revision: `082fa6b14815340d0f0d9e23b1ded318ba77c82c`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/528cc5e636c22d282ba98df31ef33e82eb6dbdcd/Z/ZoneDetect/bundled)

## Platforms

`ZoneDetect_jll.jl` is available for the following platforms:
